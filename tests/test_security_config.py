...
class TestEnvironmentSecurityConfig:
    ...
    def test_production_validation_rules(self):
        ...
        errors = config.validate()
        assert len(errors) >= 2
        assert any("Production auto-fix must require approval" in error for error in errors)
        assert any("Production environment must have notification channels" in error for error in errors)
...
class TestSecurityConfigManager:
    ...
    def test_validate_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            invalid_config.notifications = NotificationConfig()  # No notification channels
    ...
    def test_import_invalid_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            invalid_config_data = {
                ...
                "notifications": {},
                "scanner": {
                    "primary_scanner": "invalid-scanner"  # Invalid scanner
                },
                "auto_fix": {
                    "enabled": True,
                    "dry_run": False,
                ...
                "compliance": {
                    "audit_retention_days": -1  # Invalid retention
                }
            }
