...
from src.vet_core.models import (
    Base, Appointment, AppointmentStatus, ServiceType, AppointmentPriority,
    Pet, PetSpecies, PetGender, PetStatus,
    User, UserRole
)
...
class TestAppointmentModel:
    ...
    def test_appointment_creation_with_required_fields(self, session, sample_pet, 
                                                     sample_veterinarian_id, sample_clinic_id):
    ...
    def test_appointment_creation_with_all_fields(self, session, sample_appointment_data):
        ...
        assert appointment.follow_up_instructions == "Schedule dental cleaning in 6 months"
    ...
    def test_appointment_properties(self, session, sample_appointment_data):
        ...
        expected_end = appointment.scheduled_at + timedelta(minutes=appointment.duration_minutes)
    ...
    def test_appointment_invalid_status_transitions(self, session, sample_appointment_data):
    ...
    def test_appointment_emergency_priority_detection(self, session, sample_appointment_data):
    ...
    def test_appointment_soft_delete_inheritance(self, session, sample_appointment_data):
...
class TestAppointmentBusinessLogic:
    ...
    def test_appointment_workflow_complete_cycle(self, session, sample_appointment_data):
    ...
    def test_appointment_time_calculations_edge_cases(self, session, sample_appointment_data):
