...
class TestVeterinarianModel:
    ...
    def test_certification_management(self):
        ...
        vet.add_certification("CPR Certified", "Veterinary CPR Association", cert_date)
        ...
        vet.add_certification(
            "Expired Cert", "Test Organization", cert_date, expired_date
        )
        ...
        vet.add_certification(
            "Expiring Soon", "Test Organization", cert_date, expiring_date
        )
