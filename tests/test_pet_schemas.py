...
from vet_core.schemas.pet import (
    PetCreate, PetUpdate, PetResponse, PetBase,
    VaccinationRecordSchema, MedicalRecordSchema, AllergySchema,
    EmergencyContactSchema, PetMedicalHistoryUpdate, PetVaccinationUpdate,
    PetWeightUpdate, PetListResponse
)
...
class TestEmergencyContactSchema:
    ...
    def test_phone_validation(self):
        ...
        with pytest.raises(ValidationError):
            EmergencyContactSchema(phone="12345678901234567890", **base_data)  # Too long
...
class TestPetBase:
    ...
    def test_species_other_validation(self):
        ...
        pet = PetBase(
            name="Buddy",
            species=PetSpecies.DOG,
            species_other_description="ignored"
        )
        assert pet.species == PetSpecies.DOG
