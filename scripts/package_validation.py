...
def test_package_installation():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        success, output = run_command(
            [sys.executable, "-m", "pip", "install", "-e", "."], cwd=package_root
        )
...
"""
    ...
    package_root = Path(__file__).parent.parent
    success, output = run_command([sys.executable, "-c", test_script], cwd=package_root)
...
def test_documentation():
    ...
    required_files = ["README.md", "CHANGELOG.md", "LICENSE", "pyproject.toml"]
