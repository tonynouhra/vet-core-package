...
class User(BaseModel):
    ...
    address_line1: Mapped[Optional[str]] = mapped_column(
        String(255), nullable=True, comment="Primary address line"
    )

    address_line2: Mapped[Optional[str]] = mapped_column(
        String(255), nullable=True, comment="Secondary address line"
    )
    ...
    state: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True, comment="State or province"
    )

    postal_code: Mapped[Optional[str]] = mapped_column(
        String(20), nullable=True, comment="Postal or ZIP code"
    )

    country: Mapped[Optional[str]] = mapped_column(
        String(100), nullable=True, default="US", comment="Country code"
    )
    ...
    privacy_accepted_at: Mapped[Optional[str]] = mapped_column(
        String(50), nullable=True, comment="Timestamp when user accepted privacy policy"
    )
