...
class PerformanceMonitor:
        ...
        for module in modules:
            ...
            try:
                ...
                if result.returncode == 0:
                    ...
                    logger.warning(f"Failed to import {module}: {result.stderr.decode()}")
    ...
    def measure_test_execution_time(self, test_command: str = "pytest") -> float:
        ...
        try:
            ...
            ], capture_output=True, timeout=600)  # 10 minute timeout
    ...
    def measure_cpu_usage(self, operation: Callable[[], Any], duration: float = 10.0) -> float:
        """
